defmodule AtEx.Gateway.Sms.BulkTest do
  ...
  describe "Sms Gateway" do
    ...
    test "fetches sms collects data with correct params" do
      ...
      # run details through our code
      {:ok, result} = Bulk.fetch_sms(send_details)
      # assert our code gives us a single element list of messages
...
AtEx.Gateway.Payments.Mobile.B2c.b2c_checkout([%{phoneNumber: "254724540000", amount: 10, currencyCode: "KES", metadata: %{ message: "I am here"}, providerChannel: "Test"},%{phoneNumber: "254724540005", amount: 10, currencyCode: "KES", metadata: %{ message: "I am here"}, providerChannel: "Test"},%{phoneNumber: "254724540000", amount: 10, currencyCode: "KES", metadata: %{ message: "I am here"}, providerChannel: "Test"},%{phoneNumber: "254724540000", amount: 10, currencyCode: "KES", metadata: %{ message: "I am here"}, providerChannel: "Test"},%{phoneNumber: "254724540000", amount: 10, currencyCode: "KES", metadata: %{ message: "I am here"}, providerChannel: "Test"},%{phoneNumber: "254724540000", amount: 10, currencyCode: "KES", metadata: %{ message: "I am here"}, providerChannel: "Test"},%{phoneNumber: "254724540000", amount: 10, currencyCode: "KES", metadata: %{ message: "I am here"}, providerChannel: "Test"},%{phoneNumber: "254724540000", amount: 10, currencyCode: "KES", metadata: %{ message: "I am here"}, providerChannel: "Test"},%{phoneNumber: "254724540000", amount: 10, currencyCode: "KES", metadata: %{ message: "I am here"}, providerChannel: "Test"},%{phoneNumber: "254724540000", amount: 10, currencyCode: "KES", metadata: %{ message: "I am here"}, providerChannel: "Test"},%{phoneNumber: "254724540000", amount: 10, currencyCode: "KES", metadata: %{ message: "I am here"}, providerChannel: "Test"}])